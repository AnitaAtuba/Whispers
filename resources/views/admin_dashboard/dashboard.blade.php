...
@section("content")
  ...
  <div class="card-body">
    ...
    <h3 class="card-title my-4 text-primary">Hello {{auth()->user()->role}} {{auth()->user()->username}}</h3>
    <div class="row">
        <div class="col ">
            <div class="col border border-subtle p-1 card m-1">
        ...
        <div class="col border border-subtle p-1 card m-1">
            <p><i class="fa-solid fa-user-secret text-dark"></i></p>
                <p class="text-dark">Users</p>
                <p class="text-dark">{{$users}}</p>
        </div>
        <div class="col border border-subtle p-1 card m-1">
            <p><i class="fa-solid fa-file text-primary"></i></p>
